export const svgTemplate = `
    ...
    <svg:circle cx="47" cy="25" r="4" class="ledGreen" [class.on]="card.operation.getValue().bit(shlLine)" />
    <svg:circle cx="47" cy="25" r="4" class="ledOutline" />
    <svg:circle cx="58" cy="25" r="4" class="ledGreen" [class.on]="card.operation.getValue().bit(notLine)" />
    <svg:circle cx="58" cy="25" r="4" class="ledOutline" />
    <svg:circle cx="69" cy="25" r="4" class="ledGreen" [class.on]="card.operation.getValue().bit(xorLine)" />
    <svg:circle cx="69" cy="25" r="4" class="ledOutline" />
    <svg:circle cx="80" cy="25" r="4" class="ledGreen" [class.on]="card.operation.getValue().bit(orrLine)" />
    <svg:circle cx="80" cy="25" r="4" class="ledOutline" />
    <svg:circle cx="91" cy="25" r="4" class="ledGreen" [class.on]="card.operation.getValue().bit(andLine)" />
    <svg:circle cx="91" cy="25" r="4" class="ledOutline" />
    <svg:circle cx="102" cy="25" r="4" class="ledGreen" [class.on]="card.operation.getValue().bit(incLine)" />
    ...
    <svg:circle cx="201" cy="25" r="4" class="ledRed" [class.on]="card.condition.getValue().bit(snLine)" />
    <svg:circle cx="201" cy="25" r="4" class="ledOutline" />
    <svg:circle cx="212" cy="25" r="4" class="ledRed" [class.on]="card.condition.getValue().bit(cyLine)" />
    <svg:circle cx="212" cy="25" r="4" class="ledOutline" />
    <svg:circle cx="223" cy="25" r="4" class="ledRed" [class.on]="card.condition.getValue().bit(ezLine)" />
