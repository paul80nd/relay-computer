    ...
    <svg:g stroke="none" stroke-opacity="1" stroke-dasharray="none" fill="none" fill-opacity="1">
        <svg:g>
            ...
            <svg:g>
                ...
                <svg:rect x="4" y="5" width="9" height="9" 
            ...
            <svg:g>
                ...
                <svg:rect x="67" y="13.9" width="9" height="9" 
                stroke="white" stroke-linecap="round" stroke-linejoin="round" stroke-width=".5"
                />
            ...
            <svg:g>
                ...
                <svg:rect x="4" y="23" width="72" height="18" 
                stroke="white" stroke-linecap="round" stroke-linejoin="round" stroke-width=".5"
                />
            ...
            <svg:g>
                ...
                <svg:rect x="67" y="81" width="9" height="9" stroke="white" 
                ...
                <svg:rect x="4" y="89.9" width="63" height="9"
                stroke="white" stroke-linecap="round" stroke-linejoin="round" stroke-width=".5" />
            ...
            <svg:g>
                ...
                <svg:rect x="67" y="89.9" width="9" height="9" 
                stroke="white" stroke-linecap="round" stroke-linejoin="round" stroke-width=".5"
                />
            ...
            <svg:g>
                ...
                <svg:rect x="4" y="99" width="72" height="18" 
                stroke="white" stroke-linecap="round" stroke-linejoin="round" stroke-width=".5" />
            ...
            <svg:g>
                ...
                <svg:rect x="40" y="157" width="9" height="9" 
                stroke="white" stroke-linecap="round" stroke-linejoin="round" stroke-width=".5"
                />
                ...
                <svg:rect x="49" y="157" width="9" height="9" 
                stroke="white" stroke-linecap="round" stroke-linejoin="round" stroke-width=".5"
                />
                ...
                <svg:rect x="58" y="157" width="9" height="9" 
                stroke="white" stroke-linecap="round" stroke-linejoin="round" stroke-width=".5"
                />
                ...
                <svg:rect x="67" y="157" width="9" height="9" 
                stroke="white" stroke-linecap="round" stroke-linejoin="round" stroke-width=".5"
                />
                ...
                <svg:rect x="4" y="165.9" width="63" height="9" 
                stroke="white" stroke-linecap="round" stroke-linejoin="round" stroke-width=".5"
                />
            ...
            <svg:g>
                ...
                <svg:rect x="67" y="165.9" width="9" height="9" 
                stroke="white" stroke-linecap="round" stroke-linejoin="round" stroke-width=".5"
                />
            ...
            <svg:g>
                ...
                <svg:rect x="4" y="175" width="72" height="18" 
                stroke="white" stroke-linecap="round" stroke-linejoin="round" stroke-width=".5"
                />
