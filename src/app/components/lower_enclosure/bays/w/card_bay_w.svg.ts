export const svgTemplate = `
    ...
    <svg:g stroke="none" stroke-opacity="1" stroke-dasharray="none" fill="none" fill-opacity="1">
        <svg:g>
            ...
            <svg:g rc-card-sequencer-b [card]="backplane.sequencer" transform="translate(0,40)"></svg:g>
            <svg:line x1="0" y1="80" x2="237" y2="80" class="cardOutline" />
            <svg:g rc-card-control-a [card]="backplane.control" transform="translate(0,80)"></svg:g>
            <svg:line x1="0" y1="120" x2="237" y2="120" class="cardOutline" />
            <svg:g rc-card-control-b [card]="backplane.control" transform="translate(0,120)"></svg:g>
            <svg:line x1="0" y1="160" x2="237" y2="160" class="cardOutline" />
            <svg:g rc-card-decoder [card]="backplane.decoder" transform="translate(0,160)"></svg:g>
        </svg:g>
    </svg:g>
`;
